...
:: LEPT
SET LIBS=%LIBS% giflib416-static-mtdll.lib libjpeg8c-static-mtdll.lib liblept168-static-mtdll.lib  libtiff394-static-mtdll.lib zlib125-static-mtdll.lib
...
:: SET CPP_FILES=%CPP_FILES% phash/pHash.cpp phash/phcomplex.c phash/ph_fft.c phash/dirent.c

cl /DDEBUG /FestudyLamp /MT /Gy /Gd /GA /O2 /Gm- /WX- /fp:precise /Zc:forScope /Oy- /EHsc %INCLUDE_FOLDERS% %CPP_FILES% %LIBS% /link %LIB_PATH% /NODEFAULTLIB:libcmt.lib /NODEFAULTLIB:msvcprt.lib
